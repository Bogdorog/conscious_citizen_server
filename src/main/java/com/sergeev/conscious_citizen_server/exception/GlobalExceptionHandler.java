...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({DocumentNotFoundException.class, IncidentNotFoundException.class})
    ...
    @ExceptionHandler({PdfGenerationException.class, DocumentStorageException.class, Exception.class})
